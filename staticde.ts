function	StaticMethodDecorator(target:	Function,	//	the	function	itself	and	not	the	prototype				
...
class	StaticMethodDecoratorExample	{@StaticMethodDecorator	static	staticMethod()	{} }
